...
CFLAGS += -I/home/betrfs/tbb/include
CFLAGS += -L/home/betrfs/tbb
...
workload.o: workload.cpp microbench.h index.h util.h ./masstree/mtIndexAPI.hh ./BwTree/bwtree.h BTreeOLC/BTreeOLC.h BTreeOLC/BTreeOLC_child_layout.h ./pcm/pcm-memory.cpp ./pcm/pcm-numa.cpp ./papi_util.cpp ./hydralist/include/HydraList.h ./wormhole/wh.h ./hot/src/libhot-rowex.a
	$(CXX) $(CFLAGS) -I ./hydralist/include/ -I ./hydralist/src/ -I ./libcuckoo/libcuckoo/ -I/hot/src/main.h -I/home/betrfs/tbb/include \
        -c -o workload.o workload.cpp

workload: skiplist-clean workload.o bwtree.o artolc.o btree.o ./masstree/mtIndexAPI.a ./pcm/libPCM.a $(SL_OBJS)
	$(CXX) $(CFLAGS) -o workload workload.o bwtree.o artolc.o btree.o $(SL_OBJS) masstree/mtIndexAPI.a ./pcm/libPCM.a ./hydralist/libhydraList.a  ./hydralist/libart.a ./wormhole/libwh.a ./hot/src/libhot-rowex.a $(MEMMGR) -lpthread -lm -ltbb -lnuma -latomic
...
workload_string: skiplist-clean workload_string.o bwtree.o artolc.o ./masstree/mtIndexAPI.a ./pcm/libPCM.a $(SL_OBJS)
	$(CXX) $(CFLAGS) -o workload_string workload_string.o bwtree.o artolc.o  $(SL_OBJS) masstree/mtIndexAPI.a $(MEMMGR) ./pcm/libPCM.a ./hydralist_string/libhydraList.a ./hydralist_string/libart.a ./wormhole/libwh.a ./hot/libhot-rowex.a -lpthread -lm -ltbb -lnuma -latomic
